#include "viruz_build_config.hpp"
...
VIRUZ_Build_alignToGround = false;
viruz_build_inventoryHolder = objNull;

//Get Data from Userconfig
VIRUZ_BUILD_KEYBINDINGS = [
[VIRUZ_BUILD_OPENCONSTRUCTIONMENU_KEY,VIRUZ_BUILD_OPENCONSTRUCTIONMENU_SHIFT,VIRUZ_BUILD_OPENCONSTRUCTIONMENU_CTRL,VIRUZ_BUILD_OPENCONSTRUCTIONMENU_ALT],
[VIRUZ_BUILD_TURNLEFT_KEY,VIRUZ_BUILD_TURNLEFT_SHIFT,VIRUZ_BUILD_TURNLEFT_CTRL,VIRUZ_BUILD_TURNLEFT_ALT],
[VIRUZ_BUILD_TURNRIGHT_KEY,VIRUZ_BUILD_TURNRIGHT_SHIFT,VIRUZ_BUILD_TURNRIGHT_CTRL,VIRUZ_BUILD_TURNRIGHT_ALT],
[VIRUZ_BUILD_MINUSDISTANCE_KEY,VIRUZ_BUILD_MINUSDISTANCE_SHIFT,VIRUZ_BUILD_MINUSDISTANCE_CTRL,VIRUZ_BUILD_MINUSDISTANCE_ALT],
[VIRUZ_BUILD_PLUSDISTANCE_KEY,VIRUZ_BUILD_PLUSDISTANCE_SHIFT,VIRUZ_BUILD_PLUSDISTANCE_CTRL,VIRUZ_BUILD_PLUSDISTANCE_ALT]
];

waituntil {!(IsNull (findDisplay 46))};

viruz_build_keydown = (findDisplay 46) displayAddEventHandler ["KeyDown","_this call viruz_fnc_keyCheck"];
