//null = [this, getMarkerPos "Mark1", 10, 0, 0] execVM "supress.sqf";
//Parameters
...
_magazine	= "30Rnd_65x39_caseless_mag_Tracer"; //"30Rnd_65x39_caseless_mag_Tracer"; //_magazines select 0;
...
_unit forceWeaponFire [primaryWeapon _unit, "FullAuto"];
