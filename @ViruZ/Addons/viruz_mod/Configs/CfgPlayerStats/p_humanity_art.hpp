...
class horde_journal_pages_humanity_art
{
	...
	{
		idc = 1200;
		text = "\viruz_equip\playerstats\book\pages_2.paa";
	...
	{
		idc = 1201;
		text = "\viruz_equip\playerstats\humanity\humanity_bandit_middle_1.paa";
	...
	{
		idc = 1202;
		text = "\viruz_equip\playerstats\humanity\humanity_bandit_bottom_1.paa";
	...
	{
		idc = 1203;
		text = "\viruz_equip\playerstats\humanity\humanity_bandit_top_1.paa";
	...
	{
		idc = 1204;
		text = "\viruz_equip\playerstats\humanity\humanity_bandit_3.paa";
