class horde_journal_pages_journal_humanity
{
	...
	{
		idc = 1700;
		text = "\viruz_equip\playerstats\headers\journal.paa";
	...
	{
		idc = 1701;
		text = "\viruz_equip\playerstats\headers\humanity.paa";
	...
	{
		idc = 1702;
		text = "\viruz_equip\playerstats\cards\card\face_up.paa";
	...
	{
		idc = 1906;
		text = "\viruz_equip\playerstats\cards\card\face_down.paa";
		x = 0.51466 * safezoneW + safezoneX;
		y = 0.324981 * safezoneH + safezoneY;
		w = 0.26437 * safezoneW;
		h = 0.45502 * safezoneH;
