...
class RscDisplayCraftingMenu {
	idd = 6903;
	enableDisplay = 1;
	onLoad = "uiNamespace setVariable ['VIRUZ_CraftingDialog', _this select 0]; ['init'] call fn_updateCraftUI;";
	onUnload = "['close'] call fn_updateCraftUI;closeDialog 0;";
	...
	class Controls
	{
		...
		/*class craftButton: RscIGUIShortcutButton {
			...
			action = "['craft'] call fn_updateCraftUI;closeDialog 0;";
		};*/
		class craftButton: RscIGUIShortcutButton
		{
			idc = 430;
			...
			text = "Craft One"; //--- ToDo: Localize;
			x = 0.556691 * safezoneW + safezoneX;
			y = 0.741897 * safezoneH + safezoneY;
			w = 0.0757902 * safezoneW;
			h = 0.0201221 * safezoneH;
		};
		class craftAllButton: RscIGUIShortcutButton
		{
			idc = 440;
			action = "['craftAll'] call fn_updateCraftUI;closeDialog 0;";

			text = "Craft All"; //--- ToDo: Localize;
			x = 0.644304 * safezoneW + safezoneX;
			y = 0.741897 * safezoneH + safezoneY;
			w = 0.0757902 * safezoneW;
			h = 0.0201221 * safezoneH;
		};
