class RscDisplayGear {
	...
	enableDisplay = 1;
	movingEnable = 0;
	onLoad = "[] spawn object_monitorGear; {player removeMagazines _x} forEach MeleeMagazines; call gear_ui_init; call ui_gear_sound; if (isNil('IGUI_GEAR_activeFilter')) then { IGUI_GEAR_activeFilter = 0;}; private ['_dummy']; _dummy = [_this,'initDialog'] call compile preprocessFile	'\z\addons\viruz_mod\system\handleGear.sqf'; _dummy = [_this,'onLoad'] execVM	'\z\addons\viruz_mod\system\handleGear.sqf'; _dummy;";
	onUnload = "{player removeMagazines _x} forEach MeleeMagazines; call player_forceSave; call viruz_meleeMagazineCheck;";
	...
	class Controls {
		...
		class Weapon_slots_picture: RscPicture {
			...
			w = 0.028;
			h = 0.042;
			text = "\z\addons\viruz_mod\gui\gear\gear_ui_slots_weapons.paa";
		};
		...
		class Item_slots_picture: RscPicture {
			...
			w = 0.028;
			h = 0.042;
			text = "\z\addons\viruz_mod\gui\gear\gear_ui_slots_items.paa";
		};
		...
		class Backpack_slots_picture: RscPicture {
			...
			w = 0.028;
			h = 0.042;
			text = "\z\addons\viruz_mod\gui\gear\gear_ui_slots_backpacks.paa";
		};
		...
		class ListboxArrows: RscControlsGroup {
			...
			class Controls {
				class CA_B_Add: RscGearShortcutButton {
					...
					x = -2;
					style = 2048;
					onSetFocus = "private [""_dummy""]; _dummy = [_this,""onFocus""] execVM	""\z\addons\viruz_mod\system\handleGear.sqf""; _dummy;";
					onButtonClick = "private [""_dummy""]; {player removeMagazines _x} forEach MeleeMagazines; _dummy = [_this,""onLBListSelChanged""] execVM ""\z\addons\viruz_mod\system\handleGear.sqf""; _dummy;";
					text = "&lt;";
				};
				...
				class Available_items: RscIGUIListNBox {
					...
					shadow = 0;
					onKeyDown = "private [""_dummy""]; _dummy = [_this,""onKeyDown"",0,107,0,107] execVM	""\z\addons\viruz_mod\system\handleGear.sqf""; _dummy;";
					onLBSelChanged = "private [""_dummy""]; _dummy = [_this,""onLBSelChanged""] execVM ""\z\addons\viruz_mod\system\handleGear.sqf""; _dummy;";
					onLBListSelChanged = "private [""_dummy""]; _dummy = [_this,""onLBListSelChanged""] execVM ""\z\addons\viruz_mod\system\handleGear.sqf""; _dummy;";
					onKillFocus = "private [""_dummy""]; _dummy = [_this,""onKillFocus""] execVM	""\z\addons\viruz_mod\system\handleGear.sqf""; _dummy;";
					x = 0;
					y = 0;
					//w = 0.46;
					w = 0.507;
		...
		class G_GearItems: RscControlsGroup {
			...
			class Controls {
				...
				class CA_Gear_slot_secondary: CA_Gear_slot_primary {
					...
					onMouseButtonDblClick = "if (!(ctrlShown ((findDisplay 106) displayCtrl 158)) && ((gearSlotData (_this select 0)) isKindOf 'Bag_Base_EP1')) then { [player,'open_backpack',0,false,5] call viruz_zombieSpeak; };";
				};
				...
				class CA_Gear_slot_carry: CA_Gear_slot_primary {
					...
					w = 0.309;
					h = 0.174;
					onMouseEnter = "if ((ViruZ_onBack != """") && (viruz_onBack in MeleeWeapons)) then {mouseOverCarry = true;} else {mouseOverCarry = false;};";
				...
				class ButtonRearm: RscActiveText {
					idc = 132;
					style = "0x30 + 0x800";
					text = "\z\addons\viruz_mod\gui\gear\gear_ui_open.paa";
					//x = 0.916;
					x = 0.455;
					//y = 0.104;
					y = 0.002;
				...
				class ButtonOpenBag: RscActiveText {
					...
					action = "[player,'open_backpack',0,false,5] call viruz_zombieSpeak;";
				};
				...
				class Button1: RscActiveText {
					idc = 1204;
					style = "0x30 + 0x800";
					text = "\z\addons\viruz_mod\gui\gear\gear_ui_carry.paa";
					//x = 0.916;
					x = 0.455;
					//y = 0.285;
					y = 0.183;
				...
				class Button2: RscActiveText {
					idc = 1208;
					style = "0x30 + 0x800";
					text = "\z\addons\viruz_mod\gui\gear\gear_ui_hold.paa";
					//x = 0.916;
					x = 0.455;
					//y = 0.468;
					y = 0.364;
		...
		class BagItemsGroup: RscControlsGroup {
			...
			class Controls {
				class ButtonCloseBagCustom: RscActiveText {
					...
					color[] = {1,1,1,0.5};
					colorActive[] = {1,1,1,0.8};
					action = "[player,'open_backpack',0,false,5] call viruz_zombieSpeak; ctrlActivate ((findDisplay 106) displayCtrl 158);";
				};
			};
		};
		...
		class ButtonClose: RscActiveText {
			idc = 2;
			style = "0x30 + 0x800";
			text = "\z\addons\viruz_mod\gui\gear\gear_ui_close.paa";
			x = 0.919;
			y = 0.039;
			w = 0.051;
			h = 0.057;
	...
	class ControlsBackground {
		class Mainback: RscPicture {
			...
			h = 1.121;
			moving = 0;
			text = "\z\addons\viruz_mod\gui\gear\gear_bg.paa";
		};
		...
		class CA_Gear_slot_primary_background: RscPicture {
			...
			w = 0.309;
			h = 0.174;
			text = "\z\addons\viruz_mod\gui\gear\gear_ui_holding.paa";
		};
		...
		class CA_Gear_slot_secondary_background: RscPicture {
			...
			w = 0.309;
			h = 0.174;
			text = "\z\addons\viruz_mod\gui\gear\gear_ui_back.paa";
		};
		...
		class CA_Gear_slot_carry_background: RscPicture {
			...
			w = 0.309;
			h = 0.174;
			text = "\z\addons\viruz_mod\gui\gear\gear_ui_carrying.paa";
		};
		...
		class CA_Gear_slot_handgun_background: RscPicture {
			...
			w = 0.133;
			h = 0.177;
			text = "\z\addons\viruz_mod\gui\gear\gear_ui_pistol.paa";
		};
		...
		class CA_Gear_slot_special1_background: RscPicture {
			...
			text = "\z\addons\viruz_mod\gui\gear\gear_ui_vision1.paa";
		};
		...
		class CA_Gear_slot_special2_background: RscPicture {
			...
			w = 0.12;
			h = 0.16;
			text = "\z\addons\viruz_mod\gui\gear\gear_ui_vision2.paa";
		};
	};
};
