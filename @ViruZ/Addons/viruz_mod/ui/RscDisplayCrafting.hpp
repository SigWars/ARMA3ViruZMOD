class RscDisplayCrafting {
	onLoad = "[""onLoad"",_this,""RscDisplayCrafting"",'DZ_IGUI'] call compile preprocessfilelinenumbers ""A3\ui_f\scripts\initDisplay.sqf""";
	onUnload = "[""onUnload"",_this,""RscDisplayCrafting"",'DZ_IGUI'] call compile preprocessfilelinenumbers ""A3\ui_f\scripts\initDisplay.sqf""";
	idd = 1000;
...
/*		class Background {};
		...
		class CA_LeftContainerBackground : RscText {
			idc = 1001;
		...
		class CA_RightContainerBackground : RscText {
			idc = 1002;
...
//			text = $STR_DIARY_PLAYER_NAME;
		...
		class ButtonBack : RscActiveText {
			...
			onMouseButtonClick = "closeDialog (ctrlParent _this)";
		};
	
		class ItemsFilter : RscCombo {
			idc = 6554;
		...
		class LeftContainer : RscListBox {
			idc = 632;
...
//			colorText[] = {1, 1, 1, 0.1};
		...
		class ItemDescripcion : RscText {
			idc = 1005;
//			text = $STR_DIARY_PLAYER_NAME;
			text = "Item descripcion";
			x = "24 * 					(			((safezoneW / safezoneH) min 1.2) / 40) + 		(safezoneX + (safezoneW - 					((safezoneW / safezoneH) min 1.2))/2)";
			y = "3 * 					(			(			((safezoneW / safezoneH) min 1.2) / 1.2) / 25) + 		(safezoneY + (safezoneH - 					(			((safezoneW / safezoneH) min 1.2) / 1.2))/2)";
			w = "12 * 					(			((safezoneW / safezoneH) min 1.2) / 40)";
			h = "7 * 					(			(			((safezoneW / safezoneH) min 1.2) / 1.2) / 25)";
		};
		
		class ItemSourceTitleBackground : TitleBackground {
			idc = 1006;
		...
		class ItemSourceTitle : RscText {
			idc = 1007;
			text = "ITEMS";
			x = "16.6 * 					(			((safezoneW / safezoneH) min 1.2) / 40) + 		(safezoneX + (safezoneW - 					((safezoneW / safezoneH) min 1.2))/2)";
		...
		class ItemSourceTitleNeed : ItemSourceTitle {
			idc = 1008;
			text = "NEED";
		...
		class ItemSourceTitleHave : ItemSourceTitleNeed {
			idc = 1009;
			text = "HAVE";
			x = "33.5 * 					(			((safezoneW / safezoneH) min 1.2) / 40) + 		(safezoneX + (safezoneW - 					((safezoneW / safezoneH) min 1.2))/2)";
		};
		
		class ItemSourceBackground : ItemSourceTitleBackground {
			idc = 1010;
			y = "13.5 * 					(			(			((safezoneW / safezoneH) min 1.2) / 1.2) / 25) + 		(safezoneY + (safezoneH - 					(			((safezoneW / safezoneH) min 1.2) / 1.2))/2)";
			h = "6 * 					(			(			((safezoneW / safezoneH) min 1.2) / 1.2) / 25)";
		};
		
		class ItemSource1 : ItemSourceTitle {
			idc = 1011;
			text = "Item source 1";
			y = "13.5 * 					(			(			((safezoneW / safezoneH) min 1.2) / 1.2) / 25) + 		(safezoneY + (safezoneH - 					(			((safezoneW / safezoneH) min 1.2) / 1.2))/2)";
		};
		
		class ItemSource1Need : ItemSourceTitleNeed {
			idc = 1012;
			text = "0";
			y = "13.5 * 					(			(			((safezoneW / safezoneH) min 1.2) / 1.2) / 25) + 		(safezoneY + (safezoneH - 					(			((safezoneW / safezoneH) min 1.2) / 1.2))/2)";
		};
		
		class ItemSource1Have : ItemSourceTitleHave {
			idc = 1013;
			text = "0";
			y = "13.5 * 					(			(			((safezoneW / safezoneH) min 1.2) / 1.2) / 25) + 		(safezoneY + (safezoneH - 					(			((safezoneW / safezoneH) min 1.2) / 1.2))/2)";
		};
		
		class ItemSource2 : ItemSourceTitle {
			idc = 1021;
			text = "Item source 2";
			y = "14.5 * 					(			(			((safezoneW / safezoneH) min 1.2) / 1.2) / 25) + 		(safezoneY + (safezoneH - 					(			((safezoneW / safezoneH) min 1.2) / 1.2))/2)";
		};
		
		class ItemSource2Need : ItemSourceTitleNeed {
			idc = 1022;
			text = "0";
			y = "14.5 * 					(			(			((safezoneW / safezoneH) min 1.2) / 1.2) / 25) + 		(safezoneY + (safezoneH - 					(			((safezoneW / safezoneH) min 1.2) / 1.2))/2)";
		};
		
		class ItemSource2Have : ItemSourceTitleHave {
			idc = 1023;
			text = "0";
			y = "14.5 * 					(			(			((safezoneW / safezoneH) min 1.2) / 1.2) / 25) + 		(safezoneY + (safezoneH - 					(			((safezoneW / safezoneH) min 1.2) / 1.2))/2)";
		};
		
		class ItemSource3 : ItemSourceTitle {
			idc = 1031;
			text = "Item source 3";
			y = "15.5 * 					(			(			((safezoneW / safezoneH) min 1.2) / 1.2) / 25) + 		(safezoneY + (safezoneH - 					(			((safezoneW / safezoneH) min 1.2) / 1.2))/2)";
		};
		
		class ItemSource3Need : ItemSourceTitleNeed {
			idc = 1032;
			text = "0";
			y = "15.5 * 					(			(			((safezoneW / safezoneH) min 1.2) / 1.2) / 25) + 		(safezoneY + (safezoneH - 					(			((safezoneW / safezoneH) min 1.2) / 1.2))/2)";
		};
		
		class ItemSource3Have : ItemSourceTitleHave {
			idc = 1033;
			text = "0";
			y = "15.5 * 					(			(			((safezoneW / safezoneH) min 1.2) / 1.2) / 25) + 		(safezoneY + (safezoneH - 					(			((safezoneW / safezoneH) min 1.2) / 1.2))/2)";
		};
		
		class ItemSource4 : ItemSourceTitle {
			idc = 1041;
			text = "Item source 4";
			y = "16.5 * 					(			(			((safezoneW / safezoneH) min 1.2) / 1.2) / 25) + 		(safezoneY + (safezoneH - 					(			((safezoneW / safezoneH) min 1.2) / 1.2))/2)";
		};
		
		class ItemSource4Need : ItemSourceTitleNeed {
			idc = 1042;
			text = "0";
			y = "16.5 * 					(			(			((safezoneW / safezoneH) min 1.2) / 1.2) / 25) + 		(safezoneY + (safezoneH - 					(			((safezoneW / safezoneH) min 1.2) / 1.2))/2)";
		};
		
		class ItemSource4Have : ItemSourceTitleHave {
			idc = 1043;
			text = "0";
			y = "16.5 * 					(			(			((safezoneW / safezoneH) min 1.2) / 1.2) / 25) + 		(safezoneY + (safezoneH - 					(			((safezoneW / safezoneH) min 1.2) / 1.2))/2)";
		};
		
		class ItemSource5 : ItemSourceTitle {
			idc = 1051;
			text = "Item source 5";
			y = "17.5 * 					(			(			((safezoneW / safezoneH) min 1.2) / 1.2) / 25) + 		(safezoneY + (safezoneH - 					(			((safezoneW / safezoneH) min 1.2) / 1.2))/2)";
		};
		
		class ItemSource5Need : ItemSourceTitleNeed {
			idc = 1052;
			text = "0";
			y = "17.5 * 					(			(			((safezoneW / safezoneH) min 1.2) / 1.2) / 25) + 		(safezoneY + (safezoneH - 					(			((safezoneW / safezoneH) min 1.2) / 1.2))/2)";
		};
		
		class ItemSource5Have : ItemSourceTitleHave {
			idc = 1053;
			text = "0";
			y = "17.5 * 					(			(			((safezoneW / safezoneH) min 1.2) / 1.2) / 25) + 		(safezoneY + (safezoneH - 					(			((safezoneW / safezoneH) min 1.2) / 1.2))/2)";
		};
		
		class ItemSource6 : ItemSourceTitle {
			idc = 1061;
			text = "Item source 6";
			y = "18.5 * 					(			(			((safezoneW / safezoneH) min 1.2) / 1.2) / 25) + 		(safezoneY + (safezoneH - 					(			((safezoneW / safezoneH) min 1.2) / 1.2))/2)";
		};
		
		class ItemSource6Need : ItemSourceTitleNeed {
			idc = 1062;
			text = "0";
			y = "18.5 * 					(			(			((safezoneW / safezoneH) min 1.2) / 1.2) / 25) + 		(safezoneY + (safezoneH - 					(			((safezoneW / safezoneH) min 1.2) / 1.2))/2)";
		};
		
		class ItemSource6Have : ItemSourceTitleHave {
			idc = 1063;
			text = "0";
			y = "18.5 * 					(			(			((safezoneW / safezoneH) min 1.2) / 1.2) / 25) + 		(safezoneY + (safezoneH - 					(			((safezoneW / safezoneH) min 1.2) / 1.2))/2)";
		};
		
		class ItemCountMinusButton : RscActiveText {
			idc = 3;
			style = 48;
			color[] = {1, 1, 1, 0.7};
			colorText[] = {1, 1, 1, 0.7};
			...
			w = "1 * 					(			((safezoneW / safezoneH) min 1.2) / 40)";
			h = "1 * 					(			(			((safezoneW / safezoneH) min 1.2) / 1.2) / 25)";
			tooltip = "Item count minus";
			onMouseButtonClick = "systemChat ""Item count minus""";
		};
		
		class ItemCountBackground : TitleBackground {
			idc = 1070;
		...
		class ItemCountPlusButton : ItemCountMinusButton {
			idc = 4;
			...
			tooltip = "Item count plus";
			onMouseButtonClick = "systemChat ""Item count plus""";
		};
		...
		class CraftingButtonBackground : TitleBackground {
			idc = 1072;
			x = "34 * 					(			((safezoneW / safezoneH) min 1.2) / 40) + 		(safezoneX + (safezoneW - 					((safezoneW / safezoneH) min 1.2))/2)";
			y = "20.5 * 					(			(			((safezoneW / safezoneH) min 1.2) / 1.2) / 25) + 		(safezoneY + (safezoneH - 					(			((safezoneW / safezoneH) min 1.2) / 1.2))/2)";
			w = "4 * 					(			((safezoneW / safezoneH) min 1.2) / 40)";
			h = "1 * 					(			(			((safezoneW / safezoneH) min 1.2) / 1.2) / 25)";
		};
		
		class CraftingButton : RscActiveText {
			idc = 6;
			...
			h = "1 * 					(			(			((safezoneW / safezoneH) min 1.2) / 1.2) / 25)";
			//	tooltip = $STR_DISP_CLOSE;
			onMouseButtonClick = "systemChat ""Start crafting""";
		};
