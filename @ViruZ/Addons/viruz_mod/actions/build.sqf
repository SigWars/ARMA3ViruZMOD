...
//_location set [2,0];
_location set [2,getPosATL player];
...
//["viruzPublishObj",[viruz_characterID,_object,[_dir,_location],_classname]] call callRpcProcedure;
viruzPublishObj = [viruz_characterID,_object,[_dir,_location],_classname];
