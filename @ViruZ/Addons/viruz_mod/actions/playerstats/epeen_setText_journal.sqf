...
_str_left_text = "
<t size = '1.4' font = 'PuristaMedium' color = '#000000' shadow = 'false' align = 'left'>
...
{
	if (viruz_Survived == Viruz_logonDate) then // only interested if the same - assume server will only run over one day before restart
	{
		switch (true) do
		{
			case (Viruz_logonTime > 20): {_2 = (localize "str_playerstats_journal_1_a")};
			case (Viruz_logonTime > 17): {_2 = (localize "str_playerstats_journal_1_b")};
			case (Viruz_logonTime > 12): {_2 = (localize "str_playerstats_journal_1_c")};
	...
	} else
	{
		switch (true) do
		{
			case (Viruz_logonTime > 20): {_2 = (localize "str_playerstats_journal_1_e")};
			case (Viruz_logonTime > 17): {_2 = (localize "str_playerstats_journal_1_f")};
			case (Viruz_logonTime > 12): {_2 = (localize "str_playerstats_journal_1_g")};
...
// can't test viruz_Survived at home

switch (true) do
{
	case (viruz_Survived == 0): {_6 = (localize "str_playerstats_journal_2_info_1")};
	case (viruz_Survived == 1): {_6 = (localize "str_playerstats_journal_2_info_2")};
	case (viruz_Survived > 1): {_6 = format [localize "str_playerstats_journal_2_info_3", viruz_Survived]};
	default {};
};
...
// possibly filter out torch and the viruz_throwweapon thingy too.  Need to get feedback..
...
_b = "<img size = '5' image = '\z\addons\viruz_equip\playerstats\tally\0.paa'/>";
