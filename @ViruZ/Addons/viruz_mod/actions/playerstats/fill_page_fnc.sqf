...
_add_kills = "<t size = '3' font = 'PuristaMedium' color = '#000000' shadow = 'false' align = 'center' underline = 'false'>+</t>
"  + format ["<t size = '3' font = 'PuristaMedium' color = '#000000' shadow = 'false' align = 'center' underline = 'false'>%1", _extra_kills];
