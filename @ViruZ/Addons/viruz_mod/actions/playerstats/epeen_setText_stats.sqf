...
_5 = "<img size = '4.8' image = '\z\addons\viruz_equip\playerstats\tally\5.paa'/>";
_4 = "<img size = '4.8' image = '\z\addons\viruz_equip\playerstats\tally\4.paa'/>";
_3 = "<img size = '4.8' image = '\z\addons\viruz_equip\playerstats\tally\3.paa'/>";
_2 = "<img size = '4.8' image = '\z\addons\viruz_equip\playerstats\tally\2.paa'/>";
_1 = "<img size = '4.8' image = '\z\addons\viruz_equip\playerstats\tally\1.paa'/>";
_b = "<img size = '4.8' image = '\z\addons\viruz_equip\playerstats\tally\0.paa'/>";
