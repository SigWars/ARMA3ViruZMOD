...
_minWeatherChangeTimeMin = call {
 (missionConfigFile >> "cfgClima" >> "minWeatherChangeTimeMin") call BIS_fnc_getCfgData;
...
// (Suggested value: 20).
_maxWeatherChangeTimeMin = call {
	(missionConfigFile >> "cfgClima" >> "maxWeatherChangeTimeMin") call BIS_fnc_getCfgData;
...
_minTimeBetweenWeatherChangesMin = call { 
	(missionConfigFile >> "cfgClima" >> "minTimeBetweenWeatherChangesMin") call BIS_fnc_getCfgData;
...
_maxTimeBetweenWeatherChangesMin = call {
	(missionConfigFile >> "cfgClima" >> "maxTimeBetweenWeatherChangesMin") call BIS_fnc_getCfgData;
...
_minimumFog = call {
	(missionConfigFile >> "cfgClima" >> "minimumFog") call BIS_fnc_getCfgData;
...
_maximumFog = call {
	(missionConfigFile >> "cfgClima" >> "maximumFog") call BIS_fnc_getCfgData;
...
_minimumOvercast = call { 
	(missionConfigFile >> "cfgClima" >> "minimumOvercast") call BIS_fnc_getCfgData;
...
_minimumRain = call {
	(missionConfigFile >> "cfgClima" >> "minimumRain") call BIS_fnc_getCfgData;
...
_maximumRain = call { 
	(missionConfigFile >> "cfgClima" >> "maximumRain") call BIS_fnc_getCfgData;
...
// (Suggested value: 0);
_minimumWind = call {
	(missionConfigFile >> "cfgClima" >> "minimumWind") call BIS_fnc_getCfgData;
...
// (Suggested value: 8).
_maximumWind = call {
	(missionConfigFile >> "cfgClima" >> "maximumWind") call BIS_fnc_getCfgData;
...
_windChangeProbability = call {
	(missionConfigFile >> "cfgClima" >> "windChangeProbability") call BIS_fnc_getCfgData;
...
_rainIntervalRainProbability = call {
	(missionConfigFile >> "cfgClima" >> "rainIntervalRainProbability") call BIS_fnc_getCfgData;
...
// (Suggested value: 0).
_minRainIntervalTimeMin = call {
	(missionConfigFile >> "cfgClima" >> "minRainIntervalTimeMin") call BIS_fnc_getCfgData;
...
_forceRainToStopAfterOneRainInterval = call {
	(missionConfigFile >> "cfgClima" >> "forceRainToStopAfterOneRainInterval") call BIS_fnc_getCfgData;
...
drn_fnc_DynamicWeather_SetWeatherLocal = {
    ...
    0 setFog [_currentFog,0.1,(_currentFog * 3)];
    ...
    if (_currentWeatherChange == "FOG") then {
        _timeUntilCompletion setFog [_targetWeatherValue,0.1,(_targetWeatherValue * 3)];;
    };
};
...
if (isServer) then {
    ...
    0 setFog [_initialFog,0.1,(_initialFog * 3)];
