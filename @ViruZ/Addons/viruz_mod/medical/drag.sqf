...
NORRN_dropAction = player addAction ["Drop body", "\z\addons\viruz_mod\medical\drop_body.sqf",_dragee, 0, false, true];
//NORRN_carryAction = player addAction ["Carry body", "\z\addons\viruz_mod\medical\carry.sqf",_dragee, 0, false, true];
sleep 1;
