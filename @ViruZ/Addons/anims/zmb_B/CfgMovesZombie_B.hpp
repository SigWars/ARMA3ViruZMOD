class CfgMovesZombie_B : CfgMovesBasic {
	
	skeletonName = "OFP2_ManSkeleton";
	gestures = "CfgGesturesZombie_B";
	...
	class States {
		...
		class AmovPercMstp : Default {
			...
			actions = "zombieStandActions";
			file = "\DZ\anims\data\anim\zmb\Czm2\Aidl\Perc\Mltr\Czm2AidlPercMltr_pose_B.rtm";
			...
			speedC = 10000000;
			speedD = 10000000;
			collisionShape = "A3\anims_f\Data\Geom\Sdr\Perc_Wnon.p3d";	// модификация
		...
		class AmovPercMfrzDf : AmovPercMstp {
			file = "\dz\anims\data\anim\zmb\Czm2\Amov\Perc\Mfrz\Czm2AmovPercMfrzDf_B.rtm";
			duty = 0.1;
			soundOverride = "run";
			relSpeedMin = 1;
			relSpeedMax = 1;
			...
			fileB = "\dz\anims\data\anim\zmb\Czm2\Amov\Perc\Mfrz\Czm2AmovPercMfrzDf_B.rtm";
			fileC = "\dz\anims\data\anim\zmb\Czm2\Amov\Perc\Mfrz\Czm2AmovPercMfrzDf_B.rtm";
			fileD = "\dz\anims\data\anim\zmb\Czm2\Amov\Perc\Mfrz\Czm2AmovPercMfrzDf_B.rtm";
			speed = 0.8333;
			speedC = 0.8826;
			speedD = 0.8333;
			soundEdge[] = {0.22, 0.5, 0.75, 0.97};
			soundEdgeC[] = {0.21, 0.44, 0.71, 0.94};
			soundEdgeD[] = {0.18, 0.45, 0.7, 0.94};
		};
		
		class AmovPercMltrDf : AmovPercMstp {
			file = "\DZ\anims\data\anim\zmb\Czm2\Amov\Perc\Mltr\Czm2AmovPercMltrDf_B.rtm";
			duty = -0.1;
			soundOverride = "walk";
			walkcycles = 3;
			ConnectTo[] = {};
			...
			fileB = "\DZ\anims\data\anim\zmb\Czm2\Amov\Perc\Mltr\Czm2AmovPercMltrDf_B.rtm";
			fileC = "\DZ\anims\data\anim\zmb\Czm2\Amov\Perc\Mltr\Czm2AmovPercMltrDf_B.rtm";
			speed = 0.3093;
			speedC = 0.2069;
			speedD = 0.2069;
			soundEdge[] = {0.12, 0.3, 0.44, 0.64, 0.78, 0.97};
			soundEdgeC[] = {0.06, 0.21, 0.39, 0.54, 0.73, 0.89};
			soundEdgeD[] = {0.06, 0.22, 0.38, 0.55, 0.71, 0.9};
			fileD = "\DZ\anims\data\anim\zmb\Czm2\Amov\Perc\Mltr\Czm2AmovPercMltrDf_B.rtm";
		};
		...
		class DeadState : Default {
			actions = "DeadActions";
			file = "\DZ\anims\data\anim\zmb\Czm2\Adth\Perc\Czm2AdthPercMltrDnon_B.rtm";
			looped = false;
			onLandBeg = true;
			onLandEnd = true;
			soundEnabled = false;
		...
		class AmovPercMalrDf : AmovPercMstp {
			...
			file = "\DZ\anims\data\anim\zmb\Czm2\Amov\Perc\Malr\Czm2AmovPercMalrDf_B.rtm";
			interpolationSpeed = 2.5;
			fileB = "\DZ\anims\data\anim\zmb\Czm2\Amov\Perc\Malr\Czm2AmovPercMalrDf_B.rtm";
			fileC = "\DZ\anims\data\anim\zmb\Czm2\Amov\Perc\Malr\Czm2AmovPercMalrDf_B.rtm";
			fileD = "\DZ\anims\data\anim\zmb\Czm2\Amov\Perc\Malr\Czm2AmovPercMalrDf_B.rtm";
			speed = 0.8576;
			speedC = 0.7899;
			speedD = 0.8333;
			soundEdge[] = {0.2, 0.49, 0.71, 0.97};
		...
		class Czm2AtckPercMfrz : AmovPercMfrzDf {
			...
			looped = false;
			file = "\dz\anims\data\anim\zmb\Czm2\Atck\Perc\Mfrz\Czm2AtckPercMfrz_B.rtm";
			...
			interpolationRestart = true;
			fileB = "\dz\anims\data\anim\zmb\Czm2\Atck\Perc\Mfrz\Czm2AtckPercMfrz_B.rtm";
			fileC = "\dz\anims\data\anim\zmb\Czm2\Atck\Perc\Mfrz\Czm2AtckPercMfrz_B.rtm";
			fileD = "\dz\anims\data\anim\zmb\Czm2\Atck\Perc\Mfrz\Czm2AtckPercMfrz_B.rtm";
			speed = 1.3636;
			speedC = 1.3636;
			speedD = 1.3636;
		};
		...
		class Czm2AtckPercMfrz_charge : AmovPercMfrzDf {
			...
			InterpolateTo[] = {"AmovPercMstp", 1.0, "AdthPercMalrDf_v1", 1.0};
			looped = false;
			file = "\dz\anims\data\anim\zmb\Czm2\Atck\Perc\Mfrz\Czm2AtckPercMfrz_charge_B.rtm";
			...
			fileB = "\dz\anims\data\anim\zmb\Czm2\Atck\Perc\Mfrz\Czm2AtckPercMfrz_charge_B.rtm";
			fileC = "\dz\anims\data\anim\zmb\Czm2\Atck\Perc\Mfrz\Czm2AtckPercMfrz_charge_B.rtm";
			fileD = "\dz\anims\data\anim\zmb\Czm2\Atck\Perc\Mfrz\Czm2AtckPercMfrz_charge_B.rtm";
			speed = 0.6386;
			speedC = 0.6386;
			speedD = 0.6386;
		};
		...
		class AidlPercMstp01 : AmovPercMstp {
			...
			ConnectTo[] = {};
			file = "\DZ\anims\data\anim\zmb\Czm2\Aidl\Perc\Mltr\Czm2AidlPercMltr_B.rtm";
			interpolationRestart = true;
		...
		class AidlPercMstp02 : AidlPercMstp01 {
			...
			file = "\DZ\anims\data\anim\zmb\Czm2\Aidl\Perc\Mltr\Czm2AidlPercMltr_break01_B.rtm";
			...
			fileD = "\DZ\anims\data\anim\zmb\Czm2\Aidl\Perc\Mltr\Czm2AidlPercMltr_break01_B.rtm";
			speed = 0.2941;
			speedC = 0.1622;
			speedD = 0.2609;
		};
		...
		class AidlPercMstp03 : AidlPercMstp01 {
			ConnectTo[] = {"AidlPercMstp01", 1.0};
			file = "\DZ\anims\data\anim\zmb\Czm2\Aidl\Perc\Mltr\Czm2AidlPercMltr_break02_B.rtm";
			InterpolateTo[] = {"AmovPercMstp", 1.0, "AdthPercMalrDf_v1", 0.01};
			interpolationSpeed = 100;
		...
		class AmovPercMstp_sniffing1 : AmovPercMstp {
			variantAfter[] = {0, 0, 0};
			file = "\DZ\anims\data\anim\zmb\Czm2\Misc\Czm2AmovPercMstp_sniffing1_B.rtm";
			looped = false;
			InterpolateTo[] = {"AdthPercMstp_v1", 1.0};
			ConnectTo[] = {"AmovPercMstp", 1.0};
			interpolationRestart = true;
			equivalentTo = "AmovPercMstp_sniffing_randomizer";
			fileB = "\DZ\anims\data\anim\zmb\Czm2\Misc\Czm2AmovPercMstp_sniffing1_B.rtm";
			fileC = "\DZ\anims\data\anim\zmb\Czm2\Misc\Czm2AmovPercMstp_sniffing1_B.rtm";
			fileD = "\DZ\anims\data\anim\zmb\Czm2\Misc\Czm2AmovPercMstp_sniffing1_B.rtm";
			soundEnabled = false;
			speed = 0.1818;
			speedC = 0.1818;
			speedD = 0.1818;
		...
		class AmovPercMstp_sniffing2 : AmovPercMstp_sniffing1 {
			...
			ConnectTo[] = {"AmovPercMstp", 1.0};
			file = "\DZ\anims\data\anim\zmb\Czm2\Misc\Czm2AmovPercMstp_sniffing2_B.rtm";
			fileB = "\DZ\anims\data\anim\zmb\Czm2\Misc\Czm2AmovPercMstp_sniffing2_B.rtm";
			fileC = "\DZ\anims\data\anim\zmb\Czm2\Misc\Czm2AmovPercMstp_sniffing2_B.rtm";
			fileD = "\DZ\anims\data\anim\zmb\Czm2\Misc\Czm2AmovPercMstp_sniffing2_B.rtm";
			speed = 0.1389;
			speedC = 0.1389;
		};
		...
		class AmovPercMstp_aggravated : AmovPercMstp {
			...
			ConnectTo[] = {};
			looped = false;
			file = "\DZ\anims\data\anim\zmb\Czm2\Misc\Czm2AmovPercMstp_aggravated_B.rtm";
			interpolationRestart = true;
			fileB = "\DZ\anims\data\anim\zmb\Czm2\Misc\Czm2AmovPercMstp_aggravated_B.rtm";
			fileC = "\DZ\anims\data\anim\zmb\Czm2\Misc\Czm2AmovPercMstp_aggravated_B.rtm";
			fileD = "\DZ\anims\data\anim\zmb\Czm2\Misc\Czm2AmovPercMstp_aggravated_B.rtm";
			soundEnabled = false;
			speed = 0.6002;
			speedC = 0.6002;
			speedD = 0.6002;
		...
		class Czm2AtckPercMstp_BothHandsLow : AmovPercMstp {
			minPlayTime = 0.95;
			file = "\DZ\anims\data\anim\zmb\Czm2\Atck\Perc\Mstp\Czm2AtckPercMstp_LowBothHands_B.rtm";
			...
			looped = false;
			fileC = "\DZ\anims\data\anim\zmb\Czm2\Atck\Perc\Mstp\Czm2AtckPercMstp_LowBothHands_B.rtm";
			fileB = "\DZ\anims\data\anim\zmb\Czm2\Atck\Perc\Mstp\Czm2AtckPercMstp_LowBothHands_B.rtm";
			fileD = "\DZ\anims\data\anim\zmb\Czm2\Atck\Perc\Mstp\Czm2AtckPercMstp_LowBothHands_B.rtm";
			speed = 0.4762;
			speedC = 0.4762;
			speedD = 0.4762;
		};
		...
		class AmovPercMstp_knockDownBack : AmovPercMstp {
			file = "\dz\anims\data\anim\zmb\Czm2\Misc\knockdown\Czm2AmovPercMstp_knockDownBack_B.rtm";
			looped = false;
			ConnectTo[] = {"knockDownBack_pose", 1.0};
			interpolationRestart = true;
			InterpolateTo[] = {"AdthPercMstp_v1", 1.0};
			actions = "ZombieKnockedDownActions";
			fileB = "\dz\anims\data\anim\zmb\Czm2\Misc\knockdown\Czm2AmovPercMstp_knockDownBack_B.rtm";
			fileC = "\dz\anims\data\anim\zmb\Czm2\Misc\knockdown\Czm2AmovPercMstp_knockDownBack_B.rtm";
			fileD = "\dz\anims\data\anim\zmb\Czm2\Misc\knockdown\Czm2AmovPercMstp_knockDownBack_B.rtm";
			soundEnabled = false;
			speed = 0.484;
			speedC = 0.484;
			speedD = 0.484;
		...
		class knockDownBack_pose : AmovPercMstp_knockDownBack {
			file = "\dz\anims\data\anim\zmb\Czm2\Misc\knockdown\knockDownBack_pose_B.rtm";
			looped = false;
			ConnectTo[] = {"knockDownBack_Czm2AmovPercMstp", 1.0};
			InterpolateTo[] = {"AdthPpneMstp_v1", 1.0};
			fileB = "\dz\anims\data\anim\zmb\Czm2\Misc\knockdown\knockDownBack_pose_B.rtm";
			fileC = "\dz\anims\data\anim\zmb\Czm2\Misc\knockdown\knockDownBack_pose_B.rtm";
			fileD = "\dz\anims\data\anim\zmb\Czm2\Misc\knockdown\knockDownBack_pose_B.rtm";
			speed = 1000000;
			speedC = 1000000;
			speedD = 1000000;
		};
		...
		class knockDownBack_Czm2AmovPercMstp : AmovPercMstp_knockDownBack {
			minPlayTime = 0.95;
			file = "\dz\anims\data\anim\zmb\Czm2\Misc\knockdown\knockDownBack_Czm2AmovPercMstp_B.rtm";
			looped = false;
			InterpolateTo[] = {"AmovPercMstp", 1.0, "AdthPercMstp_v1", 1.0};
			ConnectTo[] = {};
			fileB = "\dz\anims\data\anim\zmb\Czm2\Misc\knockdown\knockDownBack_Czm2AmovPercMstp_B.rtm";
			fileC = "\dz\anims\data\anim\zmb\Czm2\Misc\knockdown\knockDownBack_Czm2AmovPercMstp_B.rtm";
			fileD = "\dz\anims\data\anim\zmb\Czm2\Misc\knockdown\knockDownBack_Czm2AmovPercMstp_B.rtm";
			speed = 0.2564;
			speedC = 0.2564;
			speedD = 0.2564;
		};
		...
		class Czm2AmovPercMstp_knockDownFront : AmovPercMstp {
			file = "\dz\anims\data\anim\zmb\Czm2\Misc\knockdown\Czm2AmovPercMstp_knockDownFront_B.rtm";
			looped = false;
			InterpolateTo[] = {"AdthPercMstp_v1", 1.0};
			ConnectTo[] = {"knockDownFront_pose", 1.0};
			interpolationRestart = true;
			actions = "ZombieKnockedDownActions";
			fileB = "\dz\anims\data\anim\zmb\Czm2\Misc\knockdown\Czm2AmovPercMstp_knockDownFront_B.rtm";
			fileC = "\dz\anims\data\anim\zmb\Czm2\Misc\knockdown\Czm2AmovPercMstp_knockDownFront_B.rtm";
			fileD = "\dz\anims\data\anim\zmb\Czm2\Misc\knockdown\Czm2AmovPercMstp_knockDownFront_B.rtm";
			soundEnabled = false;
			speed = 0.3846;
			speedC = 0.3846;
			speedD = 0.3846;
		...
		class knockDownFront_pose : Czm2AmovPercMstp_knockDownFront {
			file = "\dz\anims\data\anim\zmb\Czm2\Misc\knockdown\knockDownFront_pose_B.rtm";
			looped = false;
			InterpolateTo[] = {"AdthPpneMstp_v1", 1.0};
			ConnectTo[] = {"knockDownFront_Czm2AmovPercMstp", 1.0};
			fileB = "\dz\anims\data\anim\zmb\Czm2\Misc\knockdown\knockDownFront_pose_B.rtm";
			fileC = "\dz\anims\data\anim\zmb\Czm2\Misc\knockdown\knockDownFront_pose_B.rtm";
			fileD = "\dz\anims\data\anim\zmb\Czm2\Misc\knockdown\knockDownFront_pose_B.rtm";
			speed = 1000000;
			speedC = 1000000;
			speedD = 1000000;
		};
		...
		class knockDownFront_Czm2AmovPercMstp : Czm2AmovPercMstp_knockDownFront {
			minPlayTime = 0.95;
			file = "\dz\anims\data\anim\zmb\Czm2\Misc\knockdown\knockDownFront_Czm2AmovPercMstp_B.rtm";
			looped = false;
			InterpolateTo[] = {"AmovPercMstp", 1.0, "AdthPercMstp_v1", 1.0};
			fileB = "\dz\anims\data\anim\zmb\Czm2\Misc\knockdown\knockDownFront_Czm2AmovPercMstp_B.rtm";
			fileC = "\dz\anims\data\anim\zmb\Czm2\Misc\knockdown\knockDownFront_Czm2AmovPercMstp_B.rtm";
			fileD = "\dz\anims\data\anim\zmb\Czm2\Misc\knockdown\knockDownFront_Czm2AmovPercMstp_B.rtm";
			speed = 0.3093;
			speedC = 0.3093;
			speedD = 0.3093;
		};
