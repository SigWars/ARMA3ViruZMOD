private ["_class","_uid","_charID","_object","_worldspace","_key","_isVehicle","_structures","_vehicles"];
...
if (_isVehicle) then {
	...
	_key = format["CHILD:308:%1:%2:%3:%4:%5:%6:%7:%8:%9:",viruZ_instance, _class, 0 , _charID, _worldspace, [], [], 1,_uid];
