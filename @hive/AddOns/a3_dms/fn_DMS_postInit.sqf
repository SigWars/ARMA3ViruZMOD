...
//Leo 
/*if !("isKnownAccount:DMS_PersistentVehicle" call TRASHServer_system_database_query_selectSingleField) then
{
	"createAccount:DMS_PersistentVehicle:DMS_PersistentVehicle" call TRASHServer_system_database_query_fireAndForget;
};*/
...
if (DMS_ShowDifficultyColorLegend) then
{
	...
	_title setMarkerAlpha 0.5;
	{
		...
		private _markerType = "ViruZMissionEasyIcon";
		...
		switch (_difficulty) do
		{
			...
			{
				_color = "ColorYellow";
				_markerType = "ViruZMissionModerateIcon";
			};
			case "difficult":
			{
				_color = "ColorRed";
				_markerType = "ViruZMissionDifficultIcon";
			};
			case "hardcore":
			{
				_color = "ColorBlack";
				_markerType = "ViruZMissionHardcoreIcon";
			};
		};
...
//Leo
//[5, DMS_fnc_HeliParatroopers_Monitor, [], true] call TRASHServer_system_thread_addTask;
