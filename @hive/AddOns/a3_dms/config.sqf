...
/* Mission System Settings */
	...
	DMS_despawnMines_onCompletion		= false;						// Despawn mines spawned around missions when the mission is completed
...
/* AI Settings */
	...
	DMS_Spawn_AI_With_Money				= false;						// Whether or not to spawn AI with money that can be looted from the body.
	...
	DMS_GiveRespectToPlayer_OnAIKill	= false;						// Whether or not to give respect to players when they kill AI.
...
/* DonkeyPunchDMS Custom Side Factions */
	...
	DMS_ai_freeze_Only_DMS_AI			= false;					// Se deve ou não "congelar" AI que não são gerados pela DMS.
	...
	DMS_ai_offloadOnUnfreeze			= false;					// Se deve ou não descarregar AI para os clientes, uma vez que foram "não-congelado". NOTA: Esta configuração será ignorada se "DMS_ai_offload_to_client" é definida como falsa.
	DMS_ai_freezeCheckingDelay			= 15;						// How often (in seconds) DMS will check whether to freeze/un-freeze AI.
	DMS_ai_freezeOnSpawn				= false;					// Se vai ou não para congelar um grupo AI quando inicialmente gerou.
...
//											"ItemRadio"
	...
	DMS_assault_optic_chance			= 30;						// Percentage chance that an Assault Class AI will get an optic
	DMS_assault_bipod_chance			= 30;						// Percentage chance that an Assault Class AI will get a bipod
	DMS_assault_suppressor_chance		= 30;						// Percentage chance that an Assault Class AI will get a suppressor
...
//											"ItemGPS"
	...
	DMS_MG_optic_chance					= 30;						// Percentage chance that an MG Class AI will get an optic
	DMS_MG_bipod_chance					= 30;						// Percentage chance that an MG Class AI will get a bipod
	DMS_MG_suppressor_chance			= 30;						// Percentage chance that an MG Class AI will get a suppressor
	...
	DMS_MG_RandItemCount =				2;							// How many random items to add to the AI's inventory.
...
//											"optic_DMS",
	...
	DMS_CivilianVehicles =				[							// List of civilian vehicles that can spawn
											#ifdef USE_APEX_VEHICLES
											#endif
											"C_Offroad_02_unarmed_F" // até achar um outro
										];
